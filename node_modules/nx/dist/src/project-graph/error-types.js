...
class MultipleProjectsWithSameNameError extends Error {
    ...
    worktreeAdvice) {
        ...
        this.worktreeAdvice = worktreeAdvice;
        this.name = this.constructor.name;
    }
}
exports.MultipleProjectsWithSameNameError = MultipleProjectsWithSameNameError;
const RENAME_ADVICE = "Set a unique name for each project in a project.json inside the project's root. If the project does not currently have a project.json, you can create one that contains only a name.";
