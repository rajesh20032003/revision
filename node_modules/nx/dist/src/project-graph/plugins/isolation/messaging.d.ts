 ...
 */
export type WorkspaceStampedMessage = {
    workspaceRoot?: string;
};
/** Union of all plugin worker message types */
export type PluginWorkerMessage = AllMessages<PluginMessageDefs> & WorkspaceStampedMessage;
/** Union of all plugin worker result types */
export type PluginWorkerResult = AllResults<PluginMessageDefs> & WorkspaceStampedMessage;
