 ...
 * @public
 */
export type ResolveVersionForDependency = (dependencyProjectName: string) => Promise<string>;
/**
...
export declare abstract class VersionActions {
     ...
     */
    abstract updateProjectDependencies(tree: Tree, projectGraph: ProjectGraph, dependenciesToUpdate: Record<string, string>, resolveVersionForDependency?: ResolveVersionForDependency): Promise<string[]>;
}
