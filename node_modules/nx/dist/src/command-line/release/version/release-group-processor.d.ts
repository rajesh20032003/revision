...
export declare class ReleaseGroupProcessor {
     ...
     */
    private allVersionDecisionsFinalized;
    /**
    ...
    private finalizeAllVersionDecisions;
    /**
     ...
     * @internal
     */
    resolveVersionForDependency(dependencyProjectName: string): Promise<string>;
